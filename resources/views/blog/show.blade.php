      ...
      <div class="container text-center">
        ...
        <div class="row h-100">
          <div class="col-lg-8 mx-auto align-self-center">
            ...
            <p><span class="opacity-70 mr-1">on</span> <a class="text-white" href="#">{{$post->published_at}}</a></p>
...
<h2>{{$post->title}}</h2>
  <div class="container">
        ...
        {!!$post->content!!}  
                ...
                <div class="addthis_inline_share_toolbox_adbo"></div>
      ...
      <div class="col-lg-8 mx-auto">
        <div id="disqus_thread"></div>
                ...
                *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables*/
                ...
                s.src = 'https://saas-blog-nhrcta8juj.disqus.com/embed.js';
