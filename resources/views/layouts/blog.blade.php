...
.testimonials span.testimonials-post {
  ...
  <a class="navbar-brand" href="{{route('welcome')}}"><b>The Explorer</b></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="{{route('welcome')}}/about">About Us <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="{{route('welcome')}}/#team">Team <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="{{route('welcome')}}/#contact_us">Contact Us <span class="sr-only">(current)</span></a>
      </li>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="{{route('welcome')}}/coupon">Coupons <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="{{route('welcome')}}/discuss">Discussions <span class="sr-only">(current)</span></a>
      </li>
    </ul>
    @if(auth()->user())
